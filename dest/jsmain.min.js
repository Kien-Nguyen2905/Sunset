!(function (t, e) {
  ...
  function h(i) {
    ...
    return function () {
      ...
      return (function (t, e) {
        ...
        this,
        n
          ? ((t = r(this).constructor), Reflect.construct(e, arguments, t))
  ...
  var m = function t() {
      for (
        var e = !1, i = arguments.length, n = new Array(i), o = 0;
        o < i;
        o++
      )
        n[o] = arguments[o];
      ...
      for (var a = n.slice(1), r = a.length, l = 0; l < r; l++) {
        var c,
          h,
          d = a[l];
        for (var u in d) {
          d.hasOwnProperty(u) &&
            ((c = d[u]),
            e && (Array.isArray(c) || v(c))
              ? ((h = Array.isArray(c) ? [] : {}),
                (s[u] = t(!0, s.hasOwnProperty(u) ? s[u] : h, c)))
              : (s[u] = c));
        }
      }
      return s;
      ...
      (i($, [
          ...
          value: function (t, e) {
            ...
            if ("function" == typeof o) {
              for (
                ...
                a[r - 2] = arguments[r];
              o = o.call.apply(o, [this, this].concat(a));
            }
            return void 0 === o ? e : o;
          },
        },
        ...
        },
        {
          ...
          value: function (t, i) {
            var n = this;
            if (v(t)) {
              for (var e = 0, o = Object.entries(t); e < o.length; e++) {
                var s = o[e];
    ...
    z = (function () {
      ...
      function r(t) {
        ...
        c(this, r),
          ((e = a.call(this, m(!0, {}, A, i))).state = "init"),
          (e.$container = t);
        for (
          var n = 0, o = ["onLoad", "onWheel", "onClick"];
          n < o.length;
          n++
        ) {
          var s = o[n];
        ...
        i(r, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var e,
                ...
                a = (s * (100 + o * this.option("wheelFactor"))) / 100,
                a =
                  (o < 0 && Math.abs(s - this.option("minScale")) < 0.01) ||
                  (0 < o && Math.abs(s - this.option("maxScale")) < 0.01)
                    ? ((this.changedDelta += Math.abs(o)), s)
                    : ((this.changedDelta = 0),
                      Math.max(
                        Math.min(a, this.option("maxScale")),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.$content.addEventListener("load", this.onLoad),
                ...
                this.initObserver();
              var b = new E(this.$container, {
                start: function (t, e) {
                  if (!y.option("touch")) return !1;
                  if (y.velocity.scale < 0) return !1;
                  var r = e.composedPath()[0];
                  if (!b.currentPointers.length) {
                    if (
                      -1 !==
                      [
                        "BUTTON",
                  ...
                  return (
                    !g(r) &&
                    !1 !== y.trigger("touchStart", e) &&
                    ("mousedown" === e.type && e.preventDefault(),
                    (y.state = "pointerdown"),
                    y.resetDragPosition(),
                    (y.dragPosition.midPoint = null),
                    (y.dragPosition.time = Date.now()),
                    !0)
                  );
                },
                move: function (t, e, i) {
                  if ("pointerdown" === y.state)
                    if (!1 !== y.trigger("touchMove", i)) {
                      if (
                        !(
                          e.length < 2 &&
                          !0 === y.option("panOnlyZoomed") &&
                          y.content.width <= y.viewport.width &&
                          y.content.height <= y.viewport.height &&
                          y.transform.scale <= y.option("baseScale")
                        ) &&
                        (!(1 < e.length) ||
                          (y.option("zoom") && !1 !== y.option("pinchToZoom")))
                      ) {
                        var n = w(t[0], t[1]),
                          o = w(e[0], e[1]),
                        ...
                        (y.dragOffset.x += s),
                          (y.dragOffset.y += a),
                          (y.dragOffset.scale *= c),
                          (y.dragOffset.time =
                            Date.now() - y.dragPosition.time);
                        var h,
                          d,
                          u,
                          f,
                          p,
                          v,
                          g = 1 === y.dragStart.scale && y.option("lockAxis");
                        if (g && !y.lockAxis) {
                          if (
                            Math.abs(y.dragOffset.x) < 6 &&
                            Math.abs(y.dragOffset.y) < 6
                          )
                            return void i.preventDefault();
                          var m = Math.abs(
                            (180 * Math.atan2(y.dragOffset.y, y.dragOffset.x)) /
                              Math.PI
                          );
                          y.lockAxis = 45 < m && m < 135 ? "y" : "x";
                        }
                        ("xy" !== g && "y" === y.lockAxis) ||
                          (i.preventDefault(),
                          i.stopPropagation(),
                          ...
                          y.lockAxis &&
                            (y.dragOffset["x" === y.lockAxis ? "y" : "x"] = 0),
                          y.$container.classList.add(y.option("draggingClass")),
                          (y.transform.scale === y.option("baseScale") &&
                            "y" === y.lockAxis) ||
                            (y.dragPosition.x = y.dragStart.x + y.dragOffset.x),
                          (y.transform.scale === y.option("baseScale") &&
                            "x" === y.lockAxis) ||
                            (y.dragPosition.y = y.dragStart.y + y.dragOffset.y),
                          (y.dragPosition.scale =
                            y.dragStart.scale * y.dragOffset.scale),
                          1 < e.length
                            ? ((d =
                                (h = w(b.startPointers[0], b.startPointers[1]))
                                  .clientX - y.dragStart.rect.x),
                              (u = h.clientY - y.dragStart.rect.y),
                              (p = (f = y.getZoomDelta(
                                y.content.scale * y.dragOffset.scale,
                                d,
                                u
                              )).deltaX),
                              (v = f.deltaY),
                              (y.dragPosition.x -= p),
                              (y.dragPosition.y -= v),
                              (y.dragPosition.midPoint = o))
                            : y.setDragResistance(),
                          (y.transform = {
                            x: y.dragPosition.x,
                            y: y.dragPosition.y,
                            scale: y.dragPosition.scale,
                          }),
                          y.startAnimation());
                      }
                  ...
                  var i, n, o, s;
                  "pointerdown" === y.state &&
                    ((y._dragOffset = _({}, y.dragOffset)),
                    b.currentPointers.length
                      ? y.resetDragPosition()
                      : ((y.state = "decel"),
                        (y.friction = y.option("decelFriction")),
                        y.recalculateTransform(),
                        y.$container.classList.remove(
                          y.option("draggingClass")
                        ),
                        !1 !== y.trigger("touchEnd", e) &&
                          "decel" === y.state &&
                          ((i = y.option("minScale")),
                          y.transform.scale < i
                            ? y.zoomTo(i, { friction: 0.64 })
                            : ((n = y.option("maxScale")),
                              0.01 < y.transform.scale - n &&
                                ((o = y.dragPosition.midPoint || t),
                                (s = y.$content.getClientRects()[0]),
                                y.zoomTo(n, {
                                  friction: 0.64,
                                  x: o.clientX - s.left,
                                  y: o.clientY - s.top,
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              this.resizeObserver ||
                ((this.resizeObserver = new y(function () {
                  e.updateTimer ||
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var p,
                ...
                k = s == n ? S : n.getBoundingClientRect(),
                C = Math.max(s.offsetWidth, L(S.width)),
                E = Math.max(s.offsetHeight, L(S.height)),
                P = window.getComputedStyle(s);
              (C -= parseFloat(P.paddingLeft) + parseFloat(P.paddingRight)),
                (E -= parseFloat(P.paddingTop) + parseFloat(P.paddingBottom)),
                (this.viewport.width = C),
                (this.viewport.height = E),
                r &&
                  ((0.1 < Math.abs(d - w.width) ||
                    0.1 < Math.abs(u - w.height)) &&
                    ((v = d),
                    (g = u),
                    (m = Math.min(d, w.width)),
                    (y = Math.min(u, w.height)),
                    (b = Math.min(m / v || 0, y / g)),
                    (c = L(
                      (p = { width: v * b || 0, height: g * b || 0 }).width
                    )),
                    (h = L(p.height))),
                  Object.assign(o.style, {
                    width: "".concat(c, "px"),
                ...
                (this.container = { width: k.width, height: k.height }),
          ...
          },
          {
            ...
            value: function () {
              ...
              null === n && (n = this.content.width * a * 0.5),
                null === s && (s = this.content.height * a * 0.5);
              var r = this.getZoomDelta(t, n, s),
                l = r.deltaX,
                c = r.deltaY,
                n = this.content.x - l,
                s = this.content.y - c;
              ...
              var t,
                ...
                n =
                  0 < arguments.length && void 0 !== arguments[0]
                    ...
                    : {},
                o = n.x,
                s = void 0 === o ? this.content.x : o,
                a = n.y,
                r = void 0 === a ? this.content.y : a,
                l = n.scale,
                c = n.friction,
                h = void 0 === c ? this.option("friction") : c,
                d = n.ignoreBounds,
                u = void 0 !== d && d,
                l = l || this.content.scale || 1;
              u ||
                ((e = (t = this.getBounds(l)).boundX),
                (i = t.boundY),
                e && (s = Math.max(Math.min(s, e.to), e.from)),
                i && (r = Math.max(Math.min(r, i.to), i.from))),
                (this.friction = h),
                (this.transform = _(
                  _({}, this.transform),
                  {},
                ...
                h
                  ? ((this.state = "panning"),
                    (this.velocity = {
                      ...
                      scale: (1 / this.friction - 1) * (l - this.content.scale),
                    }),
                    this.startAnimation())
                  : this.endAnimation();
            },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var n,
                o,
                s = this.content.fitWidth * t,
                a = this.content.fitHeight * t,
                r = this.viewport.width,
                l = this.viewport.height;
              return (
                s < r
                  ? ((n = L(0.5 * (r - s))), (e.from = n), (e.to = n))
                  : (e.from = L(r - s)),
                a < l
                  ? ((o = 0.5 * (l - a)), (i.from = o), (i.to = o))
                  : (i.from = L(l - a)),
                { boundX: e, boundY: i }
              );
            },
          },
          {
            ...
            value: function () {
              ...
              "decel" === this.state &&
                ...
                (r = s.boundY),
                a &&
                  ((t = this.content.x < a.from), (e = this.content.x > a.to)),
                r &&
                  ((i = this.content.y < r.from), (n = this.content.y > r.to)),
                (t || e) &&
                  ((l = ((t ? a.from : a.to) - this.content.x) * o),
                  (c =
                ...
                (i || n) &&
                  ((h = ((i ? r.from : r.to) - this.content.y) * o),
                  (d =
          ...
          },
          {
            ...
            value: function () {
              var t, e, i, n, o, s, a, r, l, c, h;
              "pointerdown" === this.state &&
                ((s = (o = this.getBounds(this.dragPosition.scale)).boundX),
                (a = o.boundY),
                s &&
                  ((t = this.dragPosition.x < s.from),
                  (e = this.dragPosition.x > s.to)),
                a &&
                  ((i = this.dragPosition.y < a.from),
                  (n = this.dragPosition.y > a.to)),
                (!t && !e) ||
                  (t && e) ||
                  ((l = (r = t ? s.from : s.to) - this.dragPosition.x),
                  (this.dragPosition.x = r - 0.3 * l)),
                (!i && !n) ||
                  (i && n) ||
                  ((h = (c = i ? a.from : a.to) - this.dragPosition.y),
          ...
          },
          {
            ...
            value: function (t) {
              var e, i, n, o, s;
              t
                ? ((e = L(this.transform.x)),
                  (i = L(this.transform.y)),
                ...
                : ((e = L(this.content.x)),
                  ...
                  (n =
                    this.content.scale /
                    (this.content.width / this.content.fitWidth)),
                  (this.content = _(_({}, this.content), {}, { x: e, y: i }))),
                this.trigger("beforeTransform"),
                (e = L(this.content.x)),
                (i = L(this.content.y)),
                t && this.option("zoom")
                  ? ((o = L(this.content.fitWidth * n)),
                    (s = L(this.content.fitHeight * n)),
                    (this.content.width = o),
                    (this.content.height = s),
                    (this.transform = _(
                      _({}, this.transform),
                      {},
                      { width: o, height: s, scale: n }
                    )),
    ...
    c(this, T),
      ...
      (this._pointerStart = function (t) {
        ...
        (0 < t.buttons && 0 !== t.button) ||
          ((e = new k(t)),
          a.currentPointers.some(function (t) {
            return t.id === e.id;
          }) ||
            (a._triggerPointerStart(e, t) &&
              (window.addEventListener("mousemove", a._move),
              window.addEventListener("mouseup", a._pointerEnd))));
      }),
      (this._touchStart = function (t) {
        for (
          ...
          var n = i[e];
          a._triggerPointerStart(new k(n), t);
        }
      }),
      (this._move = function (t) {
        var i,
          e = a.currentPointers.slice(),
          n = C(t)
        ...
        try {
          for (s.s(); !(i = s.n()).done; )
            !(function () {
              var e = i.value,
                t = a.currentPointers.findIndex(function (t) {
                  return t.id === e.id;
                });
              if (t < 0) return;
              o.push(e), (a.currentPointers[t] = e);
            })();
        } catch (t) {
          s.e(t);
        } finally {
        ...
        a._moveCallback(e, a.currentPointers.slice(), t);
      }),
      (this._triggerPointerEnd = function (e, t) {
        var i = a.currentPointers.findIndex(function (t) {
          return t.id === e.id;
        });
        return !(
          i < 0 ||
          (a.currentPointers.splice(i, 1),
          a.startPointers.splice(i, 1),
          a._endCallback(e, t),
          0)
        );
      }),
      (this._pointerEnd = function (t) {
        (0 < t.buttons && 0 !== t.button) ||
          (a._triggerPointerEnd(new k(t), t) &&
            (window.removeEventListener("mousemove", a._move, { passive: !1 }),
            window.removeEventListener("mouseup", a._pointerEnd, {
              passive: !1,
            })));
      }),
      (this._touchEnd = function (t) {
        for (
          ...
          var n = i[e];
          a._triggerPointerEnd(new k(n), t);
        }
      }),
              ...
              return (
                ...
                t.addEventListener("click", function (t) {
                  ...
                  "page" in t.target.dataset &&
                    (t.preventDefault(),
                    t.stopPropagation(),
                    (e = parseInt(t.target.dataset.page, 10)) !==
                      (i = n.carousel).page &&
                    ...
                    n.classList.add("carousel__dot"),
                      ...
                      n.addEventListener("keydown", function (t) {
                        ...
                        "Enter" === i || "NumpadEnter" === i
                          ...
                          : "ArrowRight" === i
                          ? (e = n.nextSibling)
                          : "ArrowLeft" === i && (e = n.previousSibling),
                          e && e.click();
                      }),
      ...
      (i(R, [
        ...
        },
        {
          ...
          value: function (t, e, i) {
            var n,
              o,
              s = i.target.closest(".carousel__slide");
            s &&
              (i.stopPropagation(),
              (n = parseInt(s.dataset.index, 10)),
  ...
  var W = { Navigation: O, Dots: F, Sync: N },
    B = {
      slides: [],
      preload: 0,
      slidesPerPage: "auto",
    ...
    q = (function () {
      ...
      function o(t) {
        ...
        if (
          (c(this, o),
          (i = m(!0, {}, B, i)),
          ((e = n.call(this, i)).state = "init"),
          (e.$container = t),
          !(e.$container instanceof HTMLElement))
        )
          throw new Error("No root element provided");
        return (
          (e.slideNext = I(e.slideNext.bind(l(e)), 250)),
          (e.slidePrev = I(e.slidePrev.bind(l(e)), 250)),
          e.init(),
          (t.__Carousel = l(e)),
          e
        );
        ...
        i(o, [
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.$viewport =
                ...
                (this.$track =
                  this.option("track") ||
                  this.$container.querySelector(".".concat(o).concat(s.track))),
                this.$track ||
              ...
              (this.slides = []),
                this.$viewport
                  ...
                  .forEach(function (t) {
                    var e = { $el: t, isDom: !0 };
                    i.slides.push(e),
                      i.trigger("createSlide", e, i.slides.length);
                  }),
                Array.isArray(this.options.slides) &&
                  (this.slides = m(!0, b(this.slides), this.options.slides));
            },
          },
          {
            key: "updateMetrics",
            value: function () {
              ...
              this.slides.forEach(function (t, e) {
                var i = t.$el,
                  n = t.isDom || !o ? s.getSlideMetrics(i) : o;
                (t.index = e),
                  (t.width = n),
                  (t.left = a),
                  (a += o = n),
              ...
              var i = Math.max(
                  ...
                  L(this.$track.getBoundingClientRect().width)
                ),
              ...
              if (Number.isInteger(n) && i < a)
                for (var l = 0; l < this.slides.length; l += n)
                  e.push({
                    indexes: r.slice(l, l + n),
                    slides: this.slides.slice(l, l + n),
                  });
              else
              ...
              e.forEach(function (t, e) {
                (t.index = e),
                  ...
                  p &&
                    !s.option("infiniteX", s.option("infinite")) &&
                    i < a &&
              ...
              e.forEach(function (t) {
                ...
                v && e.left === v.left
                  ? ((v.width += e.width),
                    (v.slides = [].concat(b(v.slides), b(e.slides))),
                    (v.indexes = [].concat(b(v.indexes), b(e.indexes))))
                  : ((e.index = g.length), (v = e), g.push(e));
              }),
                (this.pages = g);
              var m,
                y = this.page;
              null === y &&
                ((y =
                  null !== (m = this.option("initialSlide"))
                    ? this.findPageForSlide(m)
                    : parseInt(this.option("initialPage", 0), 10) || 0),
                g[y] ||
                  (y = g.length && y > g.length ? g[g.length - 1].index : 0),
                (this.page = y),
                (this.pageIndex = y)),
                this.updatePanzoom(),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              t ||
                ...
                n.customClass &&
                  (i = t.classList).add.apply(i, b(n.customClass.split(" "))),
              ...
              return t.dataset.isTestEl && t.remove(), o;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              var e =
                ...
                s = void 0 === o ? 0 : o,
                a = e.friction,
                r = void 0 === a ? this.option("friction") : a;
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.Panzoom = new z(this.$container, t)),
                this.Panzoom.on({
                  "*": function (t) {
                    for (
          ...
          },
          {
            ...
            value: function () {
              this.Panzoom &&
                ((this.Panzoom.content = _(
                  _({}, this.Panzoom.content),
                  {},
                  {
            ...
            value: function () {
              ...
              this.slides.forEach(function (t) {
                var e = 0,
                  ...
                  n = h + c + p;
                (i -= d * (c + f + p)), (n += d * (c + f + p));
                var o = t.left + t.width > i && t.left < n;
                (i = h + l - f), (n = h + l + c + p), (i -= d * (c + f + p));
                var s = u && t.left + t.width > i && t.left < n;
                (i = h - l - f), (n = h - l + c + p), (i -= d * (c + f + p));
                var a = u && t.left + t.width > i && t.left < n;
                s || o || a
                  ? (r.createSlideEl(t),
                    o && (e = 0),
                    s && (e = -1),
                    a && (e = 1),
                    t.left + t.width > h && t.left <= h + c + p && (e = 0))
                  : r.removeSlideEl(t),
                  (t.hasDiff = e);
              });
              var n = 0,
              ...
              this.slides.forEach(function (t, e) {
                var i = 0;
                t.$el
                  ? (e !== n || t.hasDiff ? (i = o + t.hasDiff * l) : (o = 0),
                    (t.$el.style.left =
                      0.1 < Math.abs(i)
                        ? "".concat(o + t.hasDiff * l, "px")
                        : ""),
                    n++)
                  : (o += t.width);
              }),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              5 < Math.abs(t.dragOffset.x)
                ...
                : n
                ? ((i = p(this.getPageFromPosition(-1 * t.transform.x), 2)[1]),
                  this.setPage(i))
                : this.slideToClosest();
            },
          },
          ...
          },
          {
            ...
            value: function (t, e) {
              var i,
                ...
                f = this.pages.length,
                p = this.contentWidth,
                v = this.viewportWidth;
              return (
                (t = ((h % f) + f) % f),
                this.option("infiniteX", this.option("infinite")) && v < p
                  ? ((i = Math.floor(h / f) || 0),
                    (c = this.pages[t].left + i * p),
                    !0 === e &&
                      2 < f &&
                      ...
                      (a = Math.abs(n - c)),
                      (r = Math.abs(n - o)),
                      (l = Math.abs(n - s)) < a && l <= r
                        ? ((c = s), (h += f))
                        : r < a && r < l && ((c = o), (h -= f))))
                  : ((t = h = Math.max(0, Math.min(h, f - 1))),
                    (c = this.pages.length ? this.pages[t].left : 0)),
                (this.page = t),
                (this.pageIndex = h),
                null !== d &&
                  t !== d &&
                  ((this.prevPage = d),
                  (this.prevPageIndex = u),
                  this.trigger("change", t, d)),
                c
              );
            },
          },
      ...
      (i(J, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            t.cancelable &&
              !(1 < t.touches.length || 1 != l) &&
              ((e = g(t.composedPath()[0]))
                ? ((i = window.getComputedStyle(e)),
                  (n = parseInt(i.getPropertyValue("height"), 10)),
                  (s =
                    r <= (o = t.touches ? t.touches[0].screenY : t.screenY) &&
                    0 === e.scrollTop),
                  (a = o <= r && e.scrollHeight - e.scrollTop === n),
                  (s || a) && t.preventDefault())
                : t.preventDefault());
          },
        },
        {
          key: "onWheel",
          value: function (t) {
            g(t.composedPath()[0]) || t.preventDefault();
          },
        },
        {
          key: "cleanup",
  ...
  function K(t, e) {
    for (
      var i = new URL(t),
        ...
        s = 0,
        a = [].concat(b(n), b(Object.entries(e)));
      s < a.length;
      s++
    ) {
      var r = p(a[s], 2),
        ...
        },
        {
          ...
          value: function (t) {
            ...
            var e,
              ...
              o,
              s = t.src || "",
              a = t.type || this.fancybox.options.type,
              r = null;
            (s && "string" != typeof s) ||
              ((r = s.match(
                /(?:youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i
              ))
                ? ((e = K(s, this.fancybox.option("Html.youtube"))),
                  (i = encodeURIComponent(r[1])),
                  (t.videoId = i),
                  ...
                  (t.vendor = "youtube"),
                  (a = "video"))
                : (r = s.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/))
                ? ((n = K(s, this.fancybox.option("Html.vimeo"))),
                ...
                ? ((t.src = "//maps.google."
                    ...
                    .concat(
                      r[4] && 0 < r[4].indexOf("layer=c") ? "svembed" : "embed"
                    )),
                  (a = "map"))
                : (r = s.match(
                  ...
                  ((t.src = "//maps.google."
                    .concat(r[1], "/maps?q=")
                    .concat(
                      r[2].replace("query=", "q=").replace("api=1", ""),
                      "&output=embed"
                    )),
                  (a = "map")),
              a ||
                ("#" === s.charAt(0)
                  ...
                  ? ((a = "html5video"),
                    (t.format =
                      t.format || "video/" + ("ogv" === r[1] ? "ogg" : r[1])))
                  : s.match(
                      /(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i
                    )
                  ? (a = "image")
                  : s.match(/\.(pdf)((\?|#).*)?$/i) && (a = "pdf")),
              (t.type = a || this.fancybox.option("defaultType", "image")),
              ("html5video" !== a && "video" !== a) ||
                ((t.video = m({}, this.fancybox.option("Html.video"), t.video)),
                t._width && t._height
                  ? (t.ratio = parseFloat(t._width) / parseFloat(t._height))
                  : (t.ratio = t.ratio || t.video.ratio || Q.video.ratio)));
          },
        },
        {
          key: "onReady",
        ...
        },
        {
          ...
          value: function (t) {
            ...
            t.src instanceof HTMLElement
              ...
              : "string" == typeof t.src &&
                ((i =
                  2 === (e = t.src.split("#", 2)).length && "" === e[0]
                    ? e[1]
                    : e[0]),
                (n = document.getElementById(i))),
              n
                ? ("clone" === t.type || n.$placeHolder
                    ? ((o = (o = (n = n.cloneNode(!0)).getAttribute("id"))
                        ? "".concat(o, "--clone")
                        : "clone-"
              ...
              if (!1 !== t.preload && !1 !== t.autoSize && a)
                try {
                  var r = window.getComputedStyle(s),
                    ...
                    d = h.getElementsByTagName("html")[0],
                    u = h.body;
                  (a.width = ""),
          ...
          value: function (t) {
            try {
              ...
              if ("https://player.vimeo.com" === t.origin) {
                if ("ready" === e.event) {
                  var i,
                    n = S(document.getElementsByClassName("fancybox__iframe"));
                  try {
                    for (n.s(); !(i = n.n()).done; ) {
                      var o = i.value;
    ...
    (i(nt, [
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return (
            "auto" === c && (c = 0.1 < Math.abs(i / n - s / a)),
            { top: r, left: l, scale: s && i ? i / s : 1, opacity: c }
          );
        },
      },
      {
        ...
        value: function (t) {
          ...
          return (
            (a = this.fancybox.option("Image.ignoreCoveredThumbnail")
              ? ((o = document.elementFromPoint(r.left + 1, r.top + 1) === n),
                (s =
                  document.elementFromPoint(r.right - 1, r.bottom - 1) === n),
                o && s)
      ...
      },
      {
        ...
        value: function () {
          ...
          c &&
            ...
            l.$caption && (l.$caption.style.visibility = "hidden"),
            (a = this.fancybox.option("Image.zoomFriction")),
            (t = function (t) {
              var e = r.getZoomInfo(l),
                i = e.top,
                n = e.left,
                o = e.scale,
                s = e.opacity;
  ...
  var ot =
                ...
                : ((n = a.$trigger && a.$trigger.dataset),
                  (o = t.option("slug") || (n && n.fancybox)) &&
                    ...
                    (l =
                      "#" +
                      o +
                      (1 < i.slides.length ? "-" + (a.index + 1) : ""))),
                s && (this.origHash = r !== l ? r : ""),
                l &&
                  r !== l &&
          ...
          },
          {
            ...
            value: function () {
              ...
              if (o && o.plugins.Hash) {
                if (e) {
                  var s = o.Carousel;
                  if (e === o.option("slug")) return s.slideTo(i - 1);
                  var a,
                    r = S(s.slides);
                  try {
                    for (r.s(); !(a = r.n()).done; ) {
                      var l = a.value;
                      if (l.slug && l.slug === e) return s.slideTo(l.index);
                    }
                  } catch (t) {
                    r.e(t);
                  } finally {
                  ...
                  if (h && h.fancybox === e) return s.slideTo(i - 1);
                }
    ...
    st = {
      ...
      activate: function (t) {
        (st.pageXOffset = window.pageXOffset),
          (st.pageYOffset = window.pageYOffset),
          t.requestFullscreen
            ? t.requestFullscreen()
        ...
        fullscreen: {
          ...
          click: function (t) {
            t.preventDefault(),
              st.element()
                ? st.deactivate()
                : st.activate(this.fancybox.$container);
          },
        },
        slideshow: {
          type: "button",
      ...
      (i(ct, [
        ...
        },
        {
          ...
          value: function () {
            ...
            if (
              ...
              (this.build(),
              this.update(),
              (this.Slideshow = new at(t)),
              !t.Carousel.prevPage &&
                (t.option("slideshow.autoStart") && this.Slideshow.activate(),
                t.option("fullscreen.autoStart") && !st.element()))
            )
              try {
                st.activate(t.$container);
              } catch (t) {}
          },
        },
        {
          key: "onFsChange",
          value: function () {
            window.scrollTo(st.pageXOffset, st.pageYOffset);
          },
        },
        {
          key: "onSettle",
        ...
        },
        {
          ...
          value: function (t) {
            ...
            t.class && (i = e.classList).add.apply(i, b(t.class.split(" "))),
            t.attr))
        ...
        },
        {
          ...
          value: function () {
            ...
            var a,
              ...
              c = this.fancybox.plugins.Thumbs,
              ...
              for (t.s(); !(a = t.n()).done; )
                !(function () {
                  var t = a.value,
                    e = void 0,
                    i = void 0,
                    i = v(t) ? ((e = t.id), m({}, r[e], t)) : r[(e = t)];
                  if (
                    ["counter", "next", "prev", "slideshow"].includes(e) &&
                    s.fancybox.items.length < 2
                  )
                    return;
                  if ("fullscreen" === e) {
                    if (!document.fullscreenEnabled || window.fullScreen)
                      return;
                    document.addEventListener("fullscreenchange", s.onFsChange);
                  }
                  if ("thumbs" === e && (!c || "disabled" === c.state)) return;
                  if (!i) return;
            ...
            for (var i = 0, n = l; i < n.length; i++) {
              ...
              if (o.items.length) {
                ...
                h.classList.add("fancybox__toolbar__items"),
                  h.classList.add(
                    "fancybox__toolbar__items--".concat(o.position)
                  );
                var d,
                  u = S(o.items);
                try {
        ...
        },
        {
          ...
          value: function () {
            ...
            try {
              for (v.s(); !(p = v.n()).done; ) p.value.innerHTML = n;
            } catch (t) {
              v.e(t);
            } finally {
              v.f();
    ...
    gt = (function () {
      ...
      function u(t) {
        ...
        return (
          ...
          (e = n.call(this, m(!0, {}, ft, i))).bindHandlers(),
          (e.state = "init"),
          e.setItems(t),
          e.attachPlugins(u.Plugins),
          e.trigger("init"),
        ...
        i(
          ...
          [
            {
              ...
              value: function (t) {
                for (
                  ...
                  s[a - 1] = arguments[a];
                return void 0 === n
                  ? (e = d(r(u.prototype), "option", this)).call.apply(
                      e,
                      [this, t].concat(s)
                    )
                  : ("function" == typeof n &&
                      (n = n.call.apply(n, [this, this].concat(s))),
                    n);
              },
            },
            {
              ...
              value: function (t) {
                ...
                try {
                  for (n.s(); !(e = n.n()).done; ) {
                    ...
                    a &&
                      ((o = a.dataset || {}),
                      (s.src = o.src || a.getAttribute("href") || s.src),
                      (s.type = o.type || s.type),
                      !s.src &&
                        a instanceof HTMLImageElement &&
                        (s.src = a.currentSrc || s.$trigger.src));
                    var r,
                      l = s.$thumb;
                    l ||
                      ((r = s.$trigger && s.$trigger.origTarget) &&
                        (l =
                    ...
                    !c &&
                      l &&
                      !(c = l.currentSrc || l.src) &&
                      l.dataset &&
                      (c = l.dataset.lazySrc || l.dataset.src),
                      ...
                      {},
                      {
                        ...
                        Panzoom: {
                          ...
                          lockAxis: function () {
                            if (o.Carousel) {
                              var t = "x";
                              return o.option("dragToClose") && (t += "y"), t;
                            }
                          },
                        },
                        on: {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                "function" == typeof this.options.caption &&
                  (o = this.options.caption.call(this, this, this.Carousel, e)),
                  "string" == typeof o &&
                    o.length &&
                ...
                if (this.isTopmost()) {
                  ...
                  if (i && !t.ctrlKey && !t.altKey && !t.shiftKey) {
                    ...
                    !1 === this.trigger("keydown", e, t) ||
                      ("function" == typeof this[(n = i[e])] && this[n]());
                  }
                }
              },
            },
                  ...
                  if (!n || !n.contains(document.activeElement)) {
                    ...
                    for (
                      var o,
                        s = [],
                        a = 0,
                        r = Array.from(e.querySelectorAll(Y));
                      a < r.length;
                      a++
                    ) {
                      var l = r[a],
                    ...
                    t
                      ...
                      ? H(o)
                      : s.indexOf(document.activeElement) < 0 && H(e),
                ...
                if (
                  (e instanceof HTMLElement
                    ...
                    : ((n = document.createRange().createContextualFragment(e)),
                      (i = document.createElement("div")).appendChild(n)),
                  t.filter && !t.error && (i = i.querySelector(t.filter)),
                  i instanceof Element)
                )
                  return (
                    (t._className = "has-".concat(
                      o.suffix || t.type || "unknown"
                    )),
                    s.classList.add(t._className),
            ...
            },
            {
              key: "isTopmost",
              value: function () {
                return u.getInstance().id == this.id;
              },
            },
            {
              key: "close",
                ...
                t && t.preventDefault(),
                  this.isClosing() ||
                    ...
                    this.Carousel.slides.forEach(function (t) {
                      t.$content &&
                        t.index !== e.index &&
                        n.Carousel.trigger("removeSlide", t);
                    }),
                    "closing" === this.state &&
                      ((i =
                        void 0 === e.hideClass
          ...
          [
                ...
                if (
                  ...
                  (l.matches("[data-fancybox-trigger]") ||
                    ...
                    (e =
                      (t.triggerTarget = l) &&
                      l.dataset &&
                      l.dataset.fancyboxTrigger),
                    e &&
                      ((s = document.querySelectorAll(
                        '[data-fancybox="'.concat(e, '"]')
                      )),
                      (a = parseInt(l.dataset.fancyboxIndex, 10) || 0),
                      (l = s.length ? s[a] : l)),
            ...
            },
            {
              ...
              value: function (t) {
                var e,
                  ...
                  s = i.target || null,
                  a =
                    void 0 !== (i = m({}, i, u.openers.get(t))).groupAll &&
                    i.groupAll,
                  r = void 0 === i.groupAttr ? "data-fancybox" : i.groupAttr,
                  l = r && s ? s.getAttribute("".concat(r)) : "";
                if (
                  ((s && !l && !a) ||
                    ((e = i.root || (s ? s.getRootNode() : document.body)),
                ...
                var c = u.getInstance();
                return (
                  !(c && -1 < n.indexOf(c.options.$trigger)) &&
                  ((o = s ? n.indexOf(s) : o),
                  new u(
                    (n = n.map(function (t) {
                      for (
            ...
            },
            {
              key: "destroy",
              value: function () {
                for (var t; (t = u.getInstance()); ) t.destroy();
                (u.openers = new Map()),
  ...
  for (
    var mt = 0, yt = Object.entries(gt.Plugins || {});
    mt < yt.length;
    mt++
  ) {
    var bt = p(yt[mt], 2);
    bt[0];
    var xt = bt[1];
    "function" == typeof xt.create && xt.create(gt);
  }
  (t.Carousel = q), (t.Fancybox = gt), (t.Panzoom = z);
}),
  (function (e, i) {
    "function" == typeof define && define.amd
  ...
  (function (t, e) {
    ...
    function P(t) {
      ...
      if (
        ...
        for (
          var a = (s.isBorderBox = "border-box" == o.boxSizing), r = 0;
          r < S;
          r++
        ) {
          var l = w[r],
        ...
        var d = s.paddingLeft + s.paddingRight,
          ...
          p = s.marginTop + s.marginBottom,
          v = s.borderLeftWidth + s.borderRightWidth,
          g = s.borderTopWidth + s.borderBottomWidth,
          m = a && C,
          y = x(o.width);
        !1 !== y && (s.width = y + (m ? 0 : d + v));
        var b = x(o.height);
        return (
          !1 !== b && (s.height = b + (m ? 0 : u + g)),
          (s.innerWidth = s.width - (d + v)),
          (s.innerHeight = s.height - (u + g)),
          (s.outerWidth = s.width + f),
          (s.outerHeight = s.height + p),
          s
        );
      }
    }
        ...
        h.docReady(function () {
          ...
          n.forEach(function (t) {
            ...
            try {
              ...
              return void (
                d &&
                d.error("Error parsing " + o + " on " + t.className + ": " + i)
              );
            }
            var n = new r(t, e);
            a && a.data(t, l, n);
    ...
    return (
      ...
      (p.watchCSS = function () {
        this.options.watchCSS &&
          (-1 != s(this.element, ":after").content.indexOf("flickity")
            ? this.activate()
            : this.deactivate());
      }),
      (p.onkeydown = function (t) {
        var e,
          i = document.activeElement && document.activeElement != this.element;
        !this.options.accessibility ||
          i ||
          ((e = f.keyboardHandlers[t.keyCode]) && e.call(this));
      }),
      (f.keyboardHandlers = {
        37: function () {
      ...
      (i.insert = function (t, e) {
        ...
        c &&
          ...
          (a = e == i)
            ...
            : ((r = this.cells[e].element), this.slider.insertBefore(n, r)),
          0 === e
            ? (this.cells = c.concat(this.cells))
            : a
            ? (this.cells = this.cells.concat(c))
            : ((l = this.cells.splice(e, i - e)),
              (this.cells = this.cells.concat(c).concat(l))),
          this._sizeCells(c),
          this.cellChange(e, !0));
      }),
      (i.append = function (t) {
    ...
    return (
      ...
      (t.navCompanionSelect = function (t) {
        var e,
          ...
          r,
          l,
          c = this.navCompanion && this.navCompanion.selectedCells;
        c &&
          ((e = c[0]),
          (n = (i = this.navCompanion.cells.indexOf(e)) + c.length - 1),
          (o = Math.floor(
            ((s = i),
            (a = n),
            (r = this.navCompanion.cellAlign),
            (a - s) * r + s)
          )),
          this.selectCell(o, !1, t),
          this.removeNavSelectedElements(),
          o >= this.cells.length ||
            ((l = this.cells.slice(i, 1 + n)),
    ...
    return (
      ...
      (n.imagesLoaded = function () {
        ...
        this.options.imagesLoaded &&
          i((n = this).slider).on("progress", function (t, e) {
